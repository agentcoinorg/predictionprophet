...
from prediction_market_agent_tooling.tools.tavily_cached.tavily_cached import tavily_search



def web_search(query: str, max_results: int = 5, tavily_api_key: SecretStr | None = None, tavily_cache: TavilyResponseCache | None = None) -> list[WebSearchResult]:
    response = tavily_search(
        query=query,
        search_depth="advanced",
        max_results=max_results,
        include_raw_content=True,
        response_cache=tavily_cache,
