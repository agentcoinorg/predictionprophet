...
def research(
    ...
    min_scraped_sites_ratio: float = 0.0,
    ...
    if min_scraped_sites_ratio and len(unique_scraped_websites) < ceil(min_scraped_sites_ratio * len(websites_to_scrape)):
        ...
        raise ValueError(
            ...
            f"minimum required ({min_scraped_sites_ratio}). The following websites "
